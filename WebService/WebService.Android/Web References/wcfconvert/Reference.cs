...
namespace WebService.Android.wcfconvert {
    
    
    /// <remarks/>
    [System.Web.Services.WebServiceBinding(Name="BasicHttpBinding_IConvert", Namespace="http://tempuri.org/")]
    ...
    public partial class WCFTempService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public WCFTempService(string url) {
            this.Url = url;
        }
